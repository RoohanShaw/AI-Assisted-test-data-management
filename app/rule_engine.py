...
RULES: Dict[str, Dict[str, Any]] = {
    ...
    "age_years": {
        "min": 0,
        "max": 110,
        "description": "Age in whole years (0-110)"
    },
    "age_months": {
        "min": 0,
        "max": 11,
        "description": "Age months component (0-11)"
    },
    "age_days": {
        "min": 0,
        "max": 30,
        "description": "Age days component (0-30)"
    },
    "birth_time": {
        "description": "Time of birth HH:MM AM/PM"
    },
    "landline": {
        "description": "Indian landline number in STD-subscriber format (e.g. 044-23456789)"
    },
    "passport_number": {
        "description": "Indian passport number: 1 letter + 7 digits (e.g. P1234567)"
    },
    "driving_license": {
        "description": "Indian driving licence: ST-YYYY+serial (e.g. TN-2026001234567)"
    },
    "refugee_number": {
        "description": "Refugee registration number REF-YYYY-NNNNNN"
    },
    "frro_number": {
        "description": "FRRO registration number FRRO-YYYY-NNNNNN"
    },
    "abha_number": {
        "description": "ABHA (Ayushman Bharat Health Account) ##-####-####-####"
    },
    "port_of_entry": {
        "description": "Indian international airport or seaport name"
    },
    "policy_source": {
        "description": "Insurance / health scheme source name"
    },
    "policy_number": {
        "prefix": "POL",
        "description": "Insurance policy number POL-YYYY-NNNNNNNN"
    },
    "valid_date": {
        "min_year": 2020,
        "max_year": 2030,
        "description": "Validity date in DD-MM-YYYY format"
    },
    "valid_from_date": {
        "min_year": 2020,
        "max_year": 2025,
        "description": "Valid From date DD-MM-YYYY — past/current window"
    },
    "valid_to_date": {
        "min_year": 2026,
        "max_year": 2030,
        "description": "Valid To/Upto date DD-MM-YYYY — always after valid_from_date"
    },
}
